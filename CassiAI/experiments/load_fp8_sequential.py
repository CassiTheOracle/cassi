"""
Load FP8 DiffusionGemma with sequential loading (1 worker) to avoid concurrent OOM.
Tied encoder/decoder layers on same device.
"""
import os
import gc
import torch
...
# Build device map: encoder and decoder layers on SAME device
LAYERS_ON_GPU = 10
