#!/usr/bin/env python3
"""Generic QiField trainer — trunk only.

Usage:
    python3 experiments/train_qi_field.py --model qifield --N 128 --d 128 ...
"""
...
def main():
    ...
    if args.save_dir is None:
        args.save_dir = f'checkpoints/N{args.N}_d{args.d}_{args.model}_v1'
    if args.logdir is None:
        args.logdir = f'logs/tensorboard_{args.model}'
