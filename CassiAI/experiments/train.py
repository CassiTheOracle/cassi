...
Usage:
  # Physics standard
  python experiments/train.py --data physics --epochs 20

  # Text standard (loads datasets/active/ + optional --text fallback)
  python experiments/train.py --data text --epochs 10 --steps-per-epoch 2000

  # Self-driven consistency (physics or text)
  python experiments/train.py --data physics --self-driven --consistency-weight 0.1

  # Adaptive LR + curriculum + mixed precision
  python experiments/train.py --data text --adaptive --curriculum --mixed-precision
"""
