...
- `predictions/falsifiable-predictions.md`—the 50-entry prediction catalog (quantum-gravity's falsifiable table: graviton breathing mode, GW dispersion near $M_{\text{Pl}}$, no singularity)
