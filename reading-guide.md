...
- `foundations/qi-loop-mass-cascade.md`—Qi-Loop Mass Cascade: Conditional Two-Fluid De-Resonant Rings. Derived conditional supplied-ring algebra / Tested conditional branch / Hypothesized physical identification—August 2026. A declared compact phase-gradient ratio $\alpha=\varphi$ gives a Fibonacci near-closure branch and a positive ring-energy extremum; the one-run receipt leaves topology, coefficient, and unique mass selection open.
...
- `foundations/quantum-measurement-derivation.md`—CassiFI Quantum Dynamics and Measurement. Derived conditional (regulated quantum mechanics); Hypothesized (CassiFI physical identification)—August 2026. Quantizes the finite metric-bearing CassiFI field configuration as a linear wavefunctional; derives centre-of-mass Schrödinger dispersion, configuration-space entanglement, equivariant Born density, one topologically retained apparatus record, passive unitary scattering, and the no-collapse sodium-nanoparticle limit. Quantum equilibrium remains an explicit statistical postulate. DQ1–DQ9 rejects promotion of the physical identification. GQ1–GQ7 adopts a moment-map/Kähler projection architecture as a Hypothesized research direction; fibre causality passes and finite Kähler compatibility passes conditionally, while microscopic projection and the remaining physical gates fail.
