...
- `two-fluid/run_lattice_stack_falsifier.py`—M\* falsifier wave script (seven pre-registered arms, integer-M₀ ceiling law, clamp-seed theorem; run record 20260807_183839_lattice_stack_f regenerated under runs/; `--tend` continuation mode)
