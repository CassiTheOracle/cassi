...
- `two-fluid/run_lattice_stack_falsifier.py`—M\* falsifier wave script (pre-registered arms f1–f7 and the wave-4 set f8–f14 + stacked null s1, integer-M₀ ceiling law and its 60°/108° falsification, clamp-seed theorem, clamp-free rotation scan; run records 20260807_183839/190552/222200_lattice_stack_f regenerated under runs/; `--tend` continuation mode, `--scan-rotation`/`--rot`)
