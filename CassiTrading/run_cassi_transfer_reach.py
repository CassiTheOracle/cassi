...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run native/lesion/support policy reach arms")
    parser.add_argument("--out", type=Path, default=Path("_diag/cassi-transfer-reach-v1.json"))
