...
# research/equation_discovery/full_observable_operator_v4_prereg.md.
...
ROOT="_diag/matter_formation/full_observable_v4_20260919"
...
arm_args() {
  case "$1" in
    DH3) echo "--seed=20260929 --ic=3 --clusters=3 --cluster-radius=90 --separation=1125 --box-scale=7.275 --total-mass=1160000 --radius-fraction=1.0 --freeze-field=on" ;;
    DH6) echo "--seed=20260930 --ic=6 --clusters=3 --cluster-radius=150 --separation=1875 --box-scale=12.125 --total-mass=4640000 --radius-fraction=1.0 --freeze-field=on" ;;
    DHC3) echo "--seed=20261001 --ic=3 --clusters=1 --cluster-radius=120 --separation=0 --box-scale=9.70 --total-mass=2320000 --radius-fraction=1.0 --freeze-field=on" ;;
    DHL3) echo "--seed=20261002 --ic=3 --clusters=3 --cluster-radius=120 --separation=1500 --box-scale=9.70 --total-mass=2320000 --radius-fraction=1.0 --freeze-field=off" ;;
    *) return 1 ;;
  esac
}

mkdir -p "$ROOT"
for arm in DH3 DH6 DHC3 DHL3; do
  ...
  extra="$(arm_args "$arm")"
  log="$ROOT/$arm.log"
  echo "=== full-observable v4 holdout $arm start $(date -u +%FT%TZ) ==="
  ...
  echo "=== full-observable v4 holdout $arm complete $(date -u +%FT%TZ) ==="
done
