# CassiCosmos Technical Guide

For an introduction to the project, start with the [README](README.md).
This guide covers running, configuring, rendering, and verifying the simulator.
