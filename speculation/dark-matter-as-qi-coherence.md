...
$$\boxed{G_{\text{eff}} = \frac{\pi}{\rho}(1 + \xi q)G, \qquad \xi = \varphi^6 \approx 17.944}$$
...
$$G_{\text{eff}} \cdot \rho \approx \frac{\pi}{\rho_0}(1 + \xi \cdot 1) \cdot \rho_0 = \pi(1 + \xi)$$
...
- $G_{\text{eff}} = (\pi/\rho)(1 + \xi q)G$ with $\xi = \varphi^6$ (`foundations/xi-derivation.md`)
...
- `speculation/cascade-infrastructure.md`—gate chain topology, tuned vs untuned galaxies
- `speculation/qi-bubble-propulsion.md`—Qi bubble drive, energy harvesting
