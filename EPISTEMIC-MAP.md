...
| `foundations/cassi-first-principles.md` | Derived PDE and Qi definition; Asserted single-channel gate input | Two-fluid PDE, governing equations, conversion openness, and Qi gate-status audit |
...
| `foundations/refined-numeric-predictions.md` | Active derivation (C10 magnitude Derived / direction Calibrated / boundary Hypothesized—ecliptic-degeneracy audit) | Numeric predictions for the 24 Hypothesized questions; C10 $12.2°$ magnitude closure, data-calibrated direction, and unselected boundary projection |
