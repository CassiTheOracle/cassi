...
| Document | Status | Summary |
|----------|--------|---------|
| `cosmology/observational_constraints.md` | Calibrated ($w_0$ coupling form, $\xi$ pin—ledger) / Mapped ($\alpha_{\text{halo}}$ nominal, halo $q$—ledger) | DESI DR2 fit; $w_a$ tension vs DESI ($2.7\sigma$, not resolved); rotation curves |
...
| `consciousness/neurodivergence-as-gate-configuration.md` | Speculative—August 2026 (drive-mechanism layer PDE-tested 2026-08-04) | Autism/ADHD as gate configurations; wake-pileup overload; churning-gate attention |
