 ...
 *
 * <ol>
 *   <li><b>(a) Measurement determinism</b> — two rides over the <b>same</b>
 *       settled field → identical SHA-256 fingerprint. The two same-seed arms share
 *       <b>one</b> settle — the ride is a pure read of the settled snapshot
 *       (sampling {@code ∇(g·Φ)} / {@code π/ρ}, never a field mutation) — so the
