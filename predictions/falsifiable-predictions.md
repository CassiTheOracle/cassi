...
| 46 | Rung-offset mechanism | Particle physics + PDE | **Envelope positions $1+\log_\varphi m$ / $1+\log_\varphi(m+\tfrac12)$; δn = phase lag, δn(ψ) = 0.060 − 0.204ψ** | Partially tested 2026-08-03 (δn(ψ) confirmed; linear + gated conversion null; closure-emission reading null; full-catalog ψ map structureless; 38-state baseline uniform) | **What sets the wake phase ψ per rung** |
