...
| 46 | Rung-offset mechanism | Particle physics + PDE | **Envelope positions $1+\log_\varphi m$ / $1+\log_\varphi(m+\tfrac12)$; δn = phase lag, δn(ψ) = 0.060 − 0.204ψ** | Partially tested 2026-08-03 (δn(ψ) confirmed; λ null in linear regime; 38-state baseline uniform) | **Two-fluid PDE probe; nonlinear gate branch open** |
