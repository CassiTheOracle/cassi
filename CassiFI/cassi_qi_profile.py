...
from cassi_fi_paths import CONFIG_DIR, SCHEMA_DIR
...
_REGISTRY_SOURCE_DIR = SCHEMA_DIR / "cassi-fi-schema-registry"
...
def load_development_profile(
    path: Path | str = CONFIG_DIR / "cassi-qi-flow-development.json",
) -> QiFlowProfile:
