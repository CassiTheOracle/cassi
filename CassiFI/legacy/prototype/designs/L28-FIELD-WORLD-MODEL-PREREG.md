...
- Differentiable recurrence: `CassiFI/cassi_modal_torch.py`.
...
`CassiFI/field_world_model.py` and is frozen as follows:
...
- Runner: `CassiFI/verification/run_l28_field_world_model.py`
- Independent verifier: `CassiFI/verification/verify_l28_field_world_model.py`
- Raw board: `CassiFI/_diag/l28-field-world-model/l28-board.json`
- Candidate checkpoint: `CassiFI/_diag/l28-field-world-model/l28-field.pt`
- Report: `CassiFI/artifacts/l28-field-world-model/L28-FIELD-WORLD-MODEL-REPORT.md`
