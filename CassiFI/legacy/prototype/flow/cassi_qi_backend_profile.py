...
from cassi_fi_paths import ARTIFACT_DIR, CONFIG_DIR, SCHEMA_DIR

ROOT = Path(__file__).resolve().parent
DEFAULT_PROFILE = CONFIG_DIR / "cassi-qi-flow-development.json"
DEFAULT_OUTPUT_ROOT = ARTIFACT_DIR / "cassi-qi-flow-w14b-profile"
...
def _write_artifact(output_root: Path, profile_path: Path, profile: Any, profiler: dict[str, Any], raw_values: Mapping[str, tuple[bytes, dict[str, Any]]]) -> Path:
    ...
    try:
        ...
        registry = SCHEMA_DIR / "cassi-fi-schema-registry" / "manifest.json"
