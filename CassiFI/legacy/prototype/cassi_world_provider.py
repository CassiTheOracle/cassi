...
try:
    from .cassi_fi_paths import ARTIFACT_DIR, QWEN_DLL_DIR
except ImportError:  # pragma: no cover - direct script execution
    from cassi_fi_paths import ARTIFACT_DIR, QWEN_DLL_DIR

try:  # Package imports and direct ``python CassiFI/...`` use both work.
        ...
        with self._lock:
            ...
            try:
                ...
                runtime_config = RuntimeConfig(
                    ...
                    dll_dir=self.config.dll_dir or QWEN_DLL_DIR,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--state-dir", type=Path, default=ARTIFACT_DIR / "world-provider")
