...
for _path in (_CASSI_FI_ROOT, _CASSI_FI_ROOT / "verification"):
...
DEFAULT_OUTPUT_ROOT = _CASSI_FI_ROOT / "_diag" / "l18-field-output-loop"
DEFAULT_PROMPT = (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model-path", default=str(QWEN_MODEL_PATH))
    parser.add_argument("--dll-dir", default=str(QWEN_DLL_DIR))
