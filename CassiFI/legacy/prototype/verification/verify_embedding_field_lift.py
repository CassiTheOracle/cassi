...
SEED_PATH = WORKSPACE_ROOT / "CassiCosmos" / "_diag" / "cassi_qwen_embedding_field_seed.json"
GPU_PATH = WORKSPACE_ROOT / "CassiCosmos" / "_diag" / "cassi_qwen_embedding_field_gpu.json"
RECEIPT_PATH = ARTIFACT_DIR / "native" / "embedding-field-lift.json"
