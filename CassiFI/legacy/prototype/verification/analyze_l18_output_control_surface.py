...
DEFAULT_RECEIPT = _CASSI_FI_ROOT / "_diag" / "l18-field-output-loop" / "l18-first.receipt.json"
DEFAULT_OUTPUT = _CASSI_FI_ROOT / "_diag" / "l19-output-control-surface" / "l19-manifest.json"
