...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--state-dir", type=Path, default=ARTIFACT_DIR / "f5-evidence-state")
    ...
    parser.add_argument("--output", type=Path, default=ARTIFACT_DIR / "f5" / "f5-evidence.json")
    parser.add_argument("--packet-dir", type=Path, default=ARTIFACT_DIR / "f5" / "human")
    return parser
