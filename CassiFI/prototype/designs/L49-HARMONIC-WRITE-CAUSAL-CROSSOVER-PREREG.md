# L49 Harmonic Write Causal Crossover — Authoritative Frozen Preregistration

## Status: FROZEN IDENTITY-CORRECTED — 2026-08-30; no implementation or run

This joint Brain–Mind protocol corrects the identity defect in the blocked L48 contract without editing L46 or L48. The authoritative `sha256sum` of the actual L46 bytes is `1177ad06111a7c99037595d288d6fc80b6437c6c3167cf15c4e96c7df2add18e`, matching CassiMind contract review `01a05474-1345-7508-b606-309ab0f1d999`. L48 embedded a stale nonmatching L46 hash in its `corrects_before_run` field, so its approval request was withdrawn before implementation.

L49 retains L48's substantive corrections: the immutable L42 availability rule, availability-qualified symbol comparison, explicit inherited bare-write bypass and focused proof, and complete source dependency closure. No L49 implementation, focused test, smoke, raw evidence, or canonical execution existed when this protocol was frozen.

## Relationship to L48, L46, L47, and L45

- `corrects_before_run`: `designs/L48-HARMONIC-WRITE-CAUSAL-CROSSOVER-PREREG.md`, SHA-256 `0a7c98a3637ef79796e09b913e2c619f592810904453ce30125a71bc1cc7b58f`;
- `L48_status`: `BLOCKED_BEFORE_IMPLEMENTATION_IDENTITY_MISMATCH`; its identities remain reserved and it receives no implementation or evidence;
- `corrects_original_protocol`: `designs/L46-HARMONIC-WRITE-CAUSAL-CROSSOVER-PREREG.md`, actual SHA-256 `1177ad06111a7c99037595d288d6fc80b6437c6c3167cf15c4e96c7df2add18e`;
...
- `execution_dependency`: L47 ownership, implementation, smoke, and canonical execution remain blocked until L49 has one complete receipt and CassiMind has reviewed its raw arrays;
...
- `scope`: L49 tests the causal value and failure location of the existing cyclic `U_age`. Because `U_age^7=I`, L49 cannot establish bounded retirement and cannot adopt or reject an absorbing boundary.

L45, L46, L47, and L48 are not renamed or amended by L49. After a complete L49 receipt and raw-array review, CassiMind decides whether L47's deferred dependency is satisfied by this authoritative corrected replacement protocol or whether the absorbing experiment requires a fresh evidence identity.

## Ownership and integration

This CassiBrain session owns the L49 design, causal runner, focused tests, source-independent verifier, and evidence integration. L49 adds no field module and changes no L39–L47 field source.
...
New authoritative evidence identities are:

- protocol: `cassi.l49.harmonic-write-causal-crossover-protocol.v1`;
- board: `cassi.l49.harmonic-write-causal-crossover-board.v1`;
- traces: `cassi.l49.harmonic-write-causal-crossover-traces.v1`;
- verification: `cassi.l49.harmonic-write-causal-crossover-verification.v1`.

New files are:

- `designs/L49-HARMONIC-WRITE-CAUSAL-CROSSOVER-PREREG.md`;
- `tests/test_l49_harmonic_write_causal_crossover.py`;
- `verification/run_l49_harmonic_write_causal_crossover.py`;
- `verification/verify_l49_harmonic_write_causal_crossover.py`.

Raw evidence is:

- `_diag/l49-harmonic-write-causal-crossover/l49-board.json`;
- `_diag/l49-harmonic-write-causal-crossover/l49-traces.npz`.

Verified evidence is:

- `artifacts/l49-harmonic-write-causal-crossover/L49-HARMONIC-WRITE-CAUSAL-CROSSOVER-REPORT.md`;
- `artifacts/l49-harmonic-write-causal-crossover/l49-verification.json`.
...
Frozen evidence-helper and L40 ancestry closure:
...
Frozen blocked-protocol ancestry:

- `designs/L46-HARMONIC-WRITE-CAUSAL-CROSSOVER-PREREG.md`: `1177ad06111a7c99037595d288d6fc80b6437c6c3167cf15c4e96c7df2add18e`;
- `designs/L48-HARMONIC-WRITE-CAUSAL-CROSSOVER-PREREG.md`: `0a7c98a3637ef79796e09b913e2c619f592810904453ce30125a71bc1cc7b58f`.
...
L49 hash-binds and never overwrites:
...
The L49 runner must reproduce the unchanged L40 prefix exactly:
...
1. exact preregistration, exact eighteen-path source key set and hashes, L40 input hashes, board hash, trace hash, and schema identities;
2. exact L49 raw array set, shape, dtype, order, and finiteness;
