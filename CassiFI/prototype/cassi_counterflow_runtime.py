...
class DerivedCounterflowRuntime:
    ...
    def status(self) -> dict[str, Any]:
        return {
            ...
            "mode": "persisted_provider_owned",
            "persistent_state": True,
            "state_owner": "PersistentFieldProvider",
            "checkpoint_component": "shared-field.counterflow",
            "plan_execution": "derived_scratch",
            "persistent_mutation": "observed_consolidation_only",
