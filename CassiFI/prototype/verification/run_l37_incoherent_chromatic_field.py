"""Run the frozen L37 incoherent chromatic recall board."""
...
MODULE = ROOT / "cassi_incoherent_chromatic_field.py"
...
RUNNER = ROOT / "verification" / "run_l37_incoherent_chromatic_field.py"
VERIFIER = ROOT / "verification" / "verify_l37_incoherent_chromatic_field.py"
OUTPUT_DIR = ROOT / "_diag" / "l37-incoherent-chromatic-field"
BOARD_NAME = "l37-board.json"
TRACE_NAME = "l37-traces.npz"
PNG_NAME = "l37-projection.png"


class L37RunnerError(RuntimeError):
    """The canonical L37 board could not be completed."""
...
def run_board(
    ...
    try:
        l30.WhiteChromaticFieldConfig = IncoherentChromaticFieldConfig
        l30.WhiteChromaticFieldController = IncoherentChromaticFieldController
...
def main() -> int:
    ...
    if missing:
        raise L37RunnerError(f"missing bound source files: {missing!r}")
    hashes = {
