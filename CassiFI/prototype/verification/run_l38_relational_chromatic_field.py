"""Run the frozen L38 relational chromatic recall board."""
...
MODULE = ROOT / "cassi_relational_chromatic_field.py"
...
RUNNER = ROOT / "verification" / "run_l38_relational_chromatic_field.py"
VERIFIER = ROOT / "verification" / "verify_l38_relational_chromatic_field.py"
OUTPUT_DIR = ROOT / "_diag" / "l38-relational-chromatic-field"
BOARD_NAME = "l38-board.json"
TRACE_NAME = "l38-traces.npz"
PNG_NAME = "l38-projection.png"


class L38RunnerError(RuntimeError):
    """The canonical L38 board could not be completed."""
...
def run_board(
    ...
    try:
        l30.WhiteChromaticFieldConfig = RelationalChromaticFieldConfig
        l30.WhiteChromaticFieldController = RelationalChromaticFieldController
...
def main() -> int:
    ...
    if missing:
        raise L38RunnerError(f"missing bound source files: {missing!r}")
    hashes = {
