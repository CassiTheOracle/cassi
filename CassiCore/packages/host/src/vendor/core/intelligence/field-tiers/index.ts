 ...
 *
 * All formulas are pinned to the cassi-toe theory docs (READ-ONLY ground
 * truth). Every doc citation below is to `C:\Users\Carina\Workspaces\cassi
 * -toe\foundations\...`; the section numbers are the docs' own headings.
 */
 ...
 * `cassi-toe/foundations/qi-flow-double-helix.md`, "The shared φ-powers"
 ...
 *
 * Formula pinned from `cassi-toe/foundations/dimensionful-cascade.md` §2:
 *
 ...
 *
 * Formula pinned EXACTLY from `cassi-toe/foundations/qi-flow-double-helix.md`,
 ...
 *
 * Pinned from `cassi-toe/foundations/cascade-suppression-formula.md` §1.3
