...
/**
 * VENDORED — faithful runtime copy of `core/utils/activity-timeout.ts` (HEAD@d63358da),
 * self-contained (the `signalPromise` helper from `./abort.js` is inlined below).
 * Consumed by dialectic-voice-base (`ActivityTimeout`). Re-point to
 * `@cassicore/utils` when that package lands (P5 repoint log).
 */

/** Resolve when an AbortSignal fires (inlined from core/utils/abort.js). */
