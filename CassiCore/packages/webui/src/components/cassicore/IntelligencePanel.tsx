...
const MODULE_META: Record<string, { label: string; desc: string; color: string }> = {
  ...
  'reflect':               { label: 'Reflect',             desc: 'introspect',        color: 'bg-violet-400' },
  'recover':               { label: 'Recover',             desc: 'resilience',        color: 'bg-green-400' },
  'optimizer':             { label: 'Optimizer',           desc: 'adaptive',          color: 'bg-teal-400' },
  'reflex':                { label: 'Reflex',              desc: 'quick-path',        color: 'bg-lime-400' },
