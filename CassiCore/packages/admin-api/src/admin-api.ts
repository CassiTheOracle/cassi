...
import { handleChannelsRoutes } from './routes/channels.js'
import { handleChatRoutes } from './routes/chat.js'
import { handleConfigRoutes } from './routes/config.js'
import { handleContextRoutes } from './routes/context.js'
import { handleCycleHooksRoutes } from './routes/cycle-hooks.js'
import { handleObservabilityRoutes } from './routes/observability.js'
import { handleOrchestrationRoutes } from './routes/orchestration.js'
import { handlePluginAPIRoutes } from './routes/plugin-api.js'
import { handlePluginsRoutes } from './routes/plugins.js'
import { handleDebugRoutes } from './routes/debug.js'
import { handleDelegationRoutes } from './routes/delegation.js'
import { handleDialecticRoutes } from './routes/dialectic.js'
import { handleDmnRoutes } from './routes/dmn.js'
import { handleEventsRoutes } from './routes/events.js'
import { handleHealthRoutes } from './routes/health.js'
import { handleIntelligenceRoutes } from './routes/intelligence.js'
...
import { handlePermissionsRoutes } from './routes/permissions.js'
import { handleProvidersRoutes } from './routes/providers.js'
import { handleSessionsRoutes } from './routes/sessions.js'
import { handleSubagentsRoutes } from './routes/subagents.js'
import { handleTeamsRoutes } from './routes/teams.js'
import { handleToolsRoutes } from './routes/tools.js'
import { handleVerificationRoutes } from './routes/verification.js'
import { handleImprovementRoutes } from './routes/improvement.js'
import { handleHelixRoutes } from './routes/helix.js'
import { handleHelixSessionsRoutes } from './routes/helix-sessions.js'
import { handleConstellationRoutes } from './routes/constellation.js'
import { handleMeditationRoutes } from './routes/meditation.js'
import { handleDreamerRoutes } from './routes/dreamer.js'
import { handleModelDirectiveRoutes } from './routes/model-directive.js'
import { handleBlackboardRoutes } from './routes/blackboard.js'
import { handleCortexRoutes } from './routes/cortex.js'
import { handleLaminaRoutes } from './routes/lamina.js'
import { handleContextRepoRoutes } from './routes/context-repo.js'
import { handleReverieRoutes } from './routes/reverie.js'
import { handleReplayRoutes } from './routes/replay.js'
import { handlePinealRoutes } from './routes/pineal.js'
import { handleCodeStoreRoutes } from './routes/code-store.js'
import { handleThalamusRoutes } from './routes/thalamus.js'
