...
import type { ILogger, IEventBus, IntelligenceModule, IConfig, WiringDependencies } from '@cassicore/foundation'
import type { IProvider, Message, CompletionOpts } from '@cassicore/foundation'
