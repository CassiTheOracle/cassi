/**
 * Observer Broadcast Dedupe (vendor stub)
 *
 * Faithful port of CassiCore `core/intelligence/constellation/observer-broadcast-dedupe.ts`.
 * Fully self-contained (no external deps). Consumed by helix-synapse.ts as
 * runtime: `BroadcastDedupe` (check/remember) and `normalizeForDedupe`.
 */
