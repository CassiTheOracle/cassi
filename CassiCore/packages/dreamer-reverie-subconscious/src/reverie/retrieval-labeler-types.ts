/**
 * Types for the Reverie retrieval labeler.
 *
 * The labeler observes the primary's tool rounds after a retrieval event
 * and produces (retrievalId, candidateId, label) triples that feed
 * Lightning Indexer training.
 */
