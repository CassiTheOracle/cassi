...
| $r$ (tensor-to-scalar) |—| $0.003$ | **M** | Exponent matched post-hoc (ledger §10 row 495): $r = 12/N_e^2$ needs $N_e = 63.2$ (not 40); the trajectory's $r$ is excluded by BK18 |
...
| CMB axis alignment $12.2°$ (C10) | "Predicted alignment" (observational-seti §4.2); registry C10: Calibrated | Angle computed via spherical law of cosines from the measured CMB direction vectors; the bubble-boundary mechanism's orientation is fitted to the measured axis post-hoc (mechanism Hypothesized) | Planck CMB dipole and quadrupole-octopole directions | 03-cosmo.md:81; refined-numeric-predictions.md §2.3 | Calibrated |
