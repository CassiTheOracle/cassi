...
From the superconductivity derivation (`speculation/superconductivity-as-qi-coherence.md` §1.3), the conversion power is:
...
The gate chain topology (from `speculation/cascade-infrastructure.md` §1.1) provides the integration mechanism. Each gate stage (spanning ~10 rungs) receives partially processed field patterns from the stage below, performs its own computation at its own timescale, and passes integrated results upward.
...
- `speculation/superconductivity-as-qi-coherence.md`—$\lambda_{\text{eff}} \to 0$ at $q \to 1$, dissipation-free operation
- `speculation/qi-bubble-propulsion.md`—Wu Xing doping, quasicrystalline materials
- `speculation/cascade-infrastructure.md`—gate chain topology, nested processing
- `speculation/cascade-consciousness.md`—field perception, cascade nervous system
