...
enstrophy identity integrates at round-off, and the frozen-field rate reproduces the
advective increment within a measured finite-difference floor that halves with the lattice
spacing. The material reading is measured alongside: the enstrophy identity is material and
...
closes to $2.8\times10^{-6}$ on the widest family once the measured viscous profile spread is
removed, and the spread accounts for $99\%$ of the deviation of the width from the inviscid
law. The width's value is a property of the declared patch, while its transport law holds at
every span. The cumulative enstrophy remains **UNRESOLVED**.
