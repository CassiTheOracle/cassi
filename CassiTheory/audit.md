...
| Interscale stress and attenuation bridge | Exact scale-window momentum ledger; reciprocal positive-stress ladder; representative unitary splitter; routed forward/return conservation receipt | Reciprocal transfer gives dispersion and series compliance; closed coherent transfer gives interference; the routed product follows only after declaring fixed-point density fractions as port powers and excluding coherent return re-entry | A physical stress carrier, Noether tensor for the time-completed action, density/current-to-momentum map, carrier velocity or impedance, interface phases, signed return routing, and an identified observable (`foundations/interscale-stress-attenuation-boundary.md`) |
