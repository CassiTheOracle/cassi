"""Run the preregistered pair-frequency-resonant autonomous formation calculation.

Run from the CassiTheory root:
    python computations/matter_formation_closed_cp_pair_reservoir_v10.py \
        --output-dir runs/20260913_matter_formation_closed_cp_pair_reservoir_v10
"""
...
DEFAULT_OUTPUT = ROOT / "runs/20260913_matter_formation_closed_cp_pair_reservoir_v10"
SCHEMA = "cassi.matter-formation.closed-cp-pair-reservoir.v10"
