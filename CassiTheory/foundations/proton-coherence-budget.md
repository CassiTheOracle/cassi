...
localized domain-and-resolution-qualified finite-energy stationary solution,
...
a Q2-qualified finite-grid primary background, but the field fails
localization and carrier retention and establishes none of the required
physical proton data.
...
`computations/particle-stationary-q2-recovery-report.md`. The normalized
