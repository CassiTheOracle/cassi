...
| Q7 | Measurement | **Regulated conditional quantum sector** | $P(k)=\langle\Psi|P_k|\Psi\rangle$; $R_\ell^{\mathrm{CassiFI}}=1$ | Dynamics, entanglement, effective outcomes, and unique local equivariant density Derived conditional; quantum equilibrium postulated; CassiFI physical identification Hypothesized. DQ1–DQ9 is `REJECT` promotion. GQ1–GQ7 `ADOPT`s the Hypothesized moment-map/Kähler research architecture; GQ1 passes and GQ5 passes conditionally |
