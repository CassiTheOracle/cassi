...
The void side of the electron's placement is the sharp one: in the lattice frame the electron is the sharpest void (half-integer $k$) reading in the catalog, $e = m_{102}/11.5$ (0.19%)—the $k = 11.5 = 23/2$ sub-lattice void at $n = 107.075$, inside its own Compton cell $[107, 108]$—and the up quark shares the same void index one frame down, $u = m_{99}/11.5$ (0.40%): the two lightest first-generation fermions sit on the same void family. The Yukawa half-rung $n = 26.47 \approx 26.5$ (1.4%) is the same statement in the mass-generation frame. These are individual placements—the catalog is uniform against the same-density null (T9)—and the index $23/2$ carries no structural candidate of its own.
