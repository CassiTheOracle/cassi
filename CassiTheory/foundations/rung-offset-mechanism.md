...
- **Hypothesized**: the alignment–coherence correspondence (§1); sector-edge selection at half-rungs (§4.1); the catalog mapping onto $\psi$ (§4.2); the open question of what sets $\psi$ at each rung (the wake emission phase since the last closure event — §5 T1(d); the gate branch, tested null 2026-08-03, is not the dial).
