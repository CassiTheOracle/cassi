...
- `turbulence/navier-stokes-helical-dynamic-depletion.md`—Helical Geometry and the Dynamical Depletion of Vortex Stretching. Tested finite helical families / Universal sign depletion contradicted / Open scale-uniform direction-strain estimate—September 2026. A 24-run Fourier–Galerkin matrix holds the exact Beltrami control at $P=0$ while five non-Beltrami helical families, including opposite-handed tubes with normalized helicity near $10^{-18}$, develop positive signed production by $t=1/8$. The universal sign statement is contradicted for the declared families; the scale-uniform direction-strain estimate and global regularity remain open.
