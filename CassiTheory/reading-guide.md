...
- `turbulence/README.md`—Turbulence—Spectra and Navier–Stokes Geometry. Index—September 2026. Covers the conditional spectrum analysis, critical-transfer and coercivity results, filtered stress geometry, quantitative strain departure, radial and signed spectral-spread estimates, adaptive metrics, forward-deformation covariance, vorticity-seeded active occupation, scalar-Beltrami and time–curl residuals, and the phase-energy coercivity boundary.
