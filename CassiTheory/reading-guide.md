...
geometric regularity questions, adaptive positive-metric and
forward-deformation covariance reductions, scalar-Beltrami and time–curl
residual reductions, a bounded Cassi fluid-feasibility study, an LTE
radiative-material branch, and a compressible species-resolved multi-angle
extension with accounted stellar energy sources.

- `turbulence/README.md`—Turbulence—Spectra and Navier–Stokes Geometry. Index—September 2026. Covers the conditional spectrum analysis, critical-transfer and coercivity results, filtered stress geometry, quantitative strain departure, radial and signed spectral-spread estimates, adaptive metrics, forward-deformation covariance, scalar-Beltrami and time–curl residuals, and the phase-energy coercivity boundary.
