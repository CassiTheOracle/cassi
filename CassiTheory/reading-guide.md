...
Conditional turbulence spectra, exact Navier–Stokes transfer identities, geometric regularity questions, scalar-Beltrami and time–curl residual reductions, a bounded Cassi fluid-feasibility study, an LTE radiative-material branch, and a compressible species-resolved multi-angle extension with accounted stellar energy sources.
