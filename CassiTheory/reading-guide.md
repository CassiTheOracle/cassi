...
- `foundations/geometric-manifold-completion.md`—Cassi Geometric Manifold Completion Ansatz. Hypothesized completion ansatz / Derived canonical reduction and conditional fibre geometry / Tested resolution-consistent localized retained finite-grid branch and a separate nonnegative low energetic spectrum on a diffuse finite-grid quotient—September 2026. Places the density diameter, coherence ball, projective shell, affine bubble image, and scale circuit in one stratified bundle. Continuum existence and the localized branch's constrained spectrum and dynamics remain open.
- `foundations/yin-yang-qi-dynamical-geometry.md`—Yin–Yang–Qi Open Dynamical Geometry. Hypothesized integrated open-system geometry / Derived exact diagonal reduction, positivity-preserving conversion flow, covariance, ledger closure, conditional coherence-support boundary, bounded cross-domain interface, and nine-part conditional matter boundary / Tested resolution-consistent localized retained finite-grid branch and a separate nonnegative low energetic spectrum on a diffuse finite-grid quotient—September 2026. Combines the canonical populations and $q$, positive coherence fibre, relative-$U(1)_Q$ transport, endpoint/Wilson channels, and bounded cross-domain maps. Continuum qualification and the localized branch's energetic and mixed dynamical spectra remain open.
- `foundations/endpoint-link-and-localization-boundary.md`—Gauge-Covariant Endpoint Closure and the Localization Boundary. Hypothesized Wilson-link extension / Derived conditional endpoint closure, frozen-link, source-action, stationary spatial-flux, and inter-vertex transport responses / Derived minimal-sector localization no-go / Tested separate fixed-charge localized retained finite-grid branch—September 2026. Derives endpoint covariance and localization conditions, then places the remaining particle work in physical endpoint normalization, continuum qualification, and stability of the localized branch.
- `foundations/point-core-flux-sector.md`—Quantized Point-Core Flux and the Persistent-Defect Boundary. Derived conditional exterior support / Derived current-action completion no-go / Tested resolution-consistent localized retained finite-grid branch and a separate diffuse-background low energetic spectrum—September 2026. Derives the point-flux coefficient and support inequality, then tracks the smooth-core, confinement, carrier, and fluctuation branches while keeping their physical matching open.
- `foundations/nonabelian-magnetic-core-boundary.md`—Non-Abelian Magnetic Core and the Confined-Defect Boundary. Hypothesized auxiliary completion / Derived conditional smooth-core and confinement boundaries / Tested resolution-consistent localized retained finite-grid branch and a separate diffuse-background low energetic spectrum—September 2026. Tests the adjoint $SU(2)_Q$ lift, smooth BPS core, condensate confinement, pair-collapse boundary, and fixed-charge handoff. The localized branch's continuum limit and constrained spectrum remain open.
- `foundations/core-trapped-charge-support.md`—Core-Trapped Noether Charge and the Finite-Composite Boundary. Hypothesized auxiliary carrier / Derived conditional thin-tube support boundary / Tested resolution-consistent localized retained finite-grid branch; static Hessian tested on a distinct diffuse branch—September 2026. Derives the neutral-carrier number, retention condition, $A_C/L$ support term, and reduced stable separation, then records localization and retention across four same-domain grids and one larger-domain comparison.
- `foundations/particle-stationary-action-closure.md`—Particle-Sector Action and Fixed-Charge Variational Closure. Hypothesized source-free temporal completion / Derived gauge, Gauss, stationary, variational, and fluctuation-qualification boundaries / Tested resolution-consistent localized retained finite-grid branch; nonnegative $C_4$ low energetic spectrum on a distinct diffuse branch—September 2026. Supplies the fixed-charge action and full fluctuation problem while separating the localized branch from the diffuse background whose Hessian has been evaluated.
- `foundations/matter-completion-boundary.md`—Matter Completion Boundary: Nine Conditions from Coherence to a Particle Calculation. Derived conditional boundary / Hypothesized physical realization / Tested reduced receipts and a resolution-consistent localized retained finite-grid branch; nonnegative $C_4$ low energetic spectrum on a distinct diffuse branch—September 2026. Connects the exterior, interface, transport, power, reservoir, stress, gravity, particle-map, and spectrum conditions while retaining continuum, localized-branch stability, dynamics, and physical-identity boundaries.
...
- `foundations/interscale-current-soliton.md`—Interscale Yang/Yin Current and the Conditional Soliton Pinch. Hypothesized action and Wilson-link extension / Derived conditional endpoint, first-order source-action, Wilson-transport, localization, smooth-core, confinement, and carrier-support boundaries / Tested resolution-consistent localized retained finite-grid branch and a separate diffuse-background low energetic spectrum—September 2026. Derives the two-rail current, endpoint responses, point-flux support, smooth-core boundary, and carrier-supported fixed-charge handoff. Continuum qualification, the localized branch's constrained spectrum and dynamics, and physical matching remain open.
...
- `foundations/proton-coherence-budget.md`—Proton Coherence Budget and Planck-to-Proton Scale Circuit. Mapped proton coordinate and selected carrier coupling / Derived conditional arithmetic and current identities / Hypothesized physical mechanisms / Tested resolution-consistent localized retained finite-grid branch and a separate nonnegative $C_4$ low energetic spectrum on a diffuse finite-grid quotient—September 2026. Separates the independent-step lifetime arithmetic from the two-rail current mechanism, then follows the endpoint, point-core, confinement, carrier, and fixed-charge particle branches. One Mapped coefficient point supports a localized retained branch across four same-domain grids and one larger-domain comparison; a distinct diffuse field carries the existing low energetic spectrum. Continuum qualification, stability and dynamics of the localized branch, proton identification, and a physical lifetime remain open.
