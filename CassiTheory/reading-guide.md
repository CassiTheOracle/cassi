...
geometric regularity questions, adaptive positive-metric reductions,
scalar-Beltrami and time–curl residual reductions, a bounded Cassi
...
- `turbulence/README.md`—Turbulence—Spectra and Navier–Stokes Geometry. Index—September 2026. Covers the conditional spectrum analysis, critical-transfer and coercivity results, filtered stress geometry, quantitative strain departure, radial and signed spectral-spread estimates, the scalar-Beltrami and time–curl residuals, and the phase-energy coercivity boundary.
