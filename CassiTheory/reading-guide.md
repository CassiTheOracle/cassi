...
- `hypotheses/exoplanet-phi-spacing.md`—Exoplanet Orbital Spacing from the Wake-Wave Mechanism. Hypothesized. A conditional disk ring ladder gives the detached-orbit target $P_{\rm out}/P_{\rm in}=\varphi^{3/2}$; the confirmed-catalog Kepler classifier is **INDETERMINATE** and the scientific verdict **INCONCLUSIVE** because the target window overlaps the conventional wide-of-2:1 excess; the disk-gap channel remains pending.
