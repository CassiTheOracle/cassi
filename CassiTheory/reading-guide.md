...
- `foundations/loop-to-bubble-projection-theorem.md`—Loop-to-Bubble Projection Theorem: Shared-Support Counterflow, Coherence, and Scale Separation. Derived conditional projection and population spectrum; Derived regulated pure-gauge identities, exact fixed-boundary gauge-fibre support, exact isolated-square radial Feshbach transfer and weak-coupling character-cutoff theorem, conditional full-holonomy block theorem, and exact bare-cylindrical refinement obstruction; Hypothesized microscopic physical identification—September 2026. Four carrier populations project to the canonical PDE and their coherence fills the affine bubble volume. In the separate source-free $SU(2)$ comparison, an exact Haar-isometric path-holonomy pullback preserves endpoint gauge covariance and the electric Casimir, but a genuine $2\times2$ refinement gives leakage $\|Qh_fJ1\|_2=2x_f$ and excludes a bare full-Hamiltonian block. The isolated-square class-function operator has an exact energy-dependent Feshbach pencil and fixed-window isolation; fixed low bare-cutoff levels converge with vanishing discarded mass exactly when $N/x^{1/4}\to\infty$, equivalently $gN\to\infty$. Fixed and finite-scaled cutoffs fail as bare weak-coupling limits. The fixed fundamental-boundary internal Gauss fibre has 14 states but is not dynamically closed under plaquette multiplication. Interacting boundary-sector recoupling, volume-uniform resolvent control, thermodynamic and continuum limits, a regulator-independent mass gap and Cassi microscopic identification remain unresolved.
