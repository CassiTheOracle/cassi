...
- `foundations/loop-to-bubble-projection-theorem.md`—Loop-to-Bubble Projection Theorem: Shared-Support Counterflow, Coherence, and Scale Separation. Derived conditional projection and population spectrum; Derived regulated pure-gauge identities, exact fixed-boundary gauge-fibre support, conditional full-holonomy block theorem, and exact bare-cylindrical refinement obstruction; Hypothesized microscopic physical identification—September 2026. Four carrier populations project to the canonical PDE and their coherence fills the affine bubble volume. In the separate source-free $SU(2)$ comparison, an exact Haar-isometric path-holonomy pullback preserves endpoint gauge covariance and the electric Casimir, but a genuine $2\times2$ refinement gives leakage $\|Qh_fJ1\|_2=2x_f$ and excludes that bare map as a full-Hamiltonian intertwiner. The fixed fundamental-boundary internal Gauss fibre has exactly 14 states once $j_{\max}\geq1$, but Wilson multiplication changes its boundary sector. Strong-bare-coupling stability, exact-vacuum Poincaré identities and conditional full-holonomy estimates remain distinct from the unresolved boundary-sector self-energy, weak-coupling uniform control, continuum construction, mass gap and Cassi microscopic identification.
