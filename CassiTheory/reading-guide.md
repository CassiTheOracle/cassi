...
- `foundations/geometric-manifold-completion.md`—Cassi Geometric Manifold Completion Ansatz. Hypothesized completion ansatz / Derived canonical reduction and conditional fibre geometry / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Places the density diameter, coherence ball, projective shell, affine bubble image, and scale circuit in one stratified bundle. The global phase mode remains grid-scale; localization, retention, convergence, and PA43 remain open.
- `foundations/yin-yang-qi-dynamical-geometry.md`—Yin–Yang–Qi Open Dynamical Geometry. Hypothesized integrated open-system geometry / Derived exact diagonal reduction, positivity-preserving conversion flow, covariance, ledger closure, conditional coherence-support boundary, bounded cross-domain interface, and nine-part conditional matter boundary / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Combines the canonical populations and $q$, positive coherence fibre, relative-$U(1)_Q$ transport, endpoint/Wilson channels, and bounded cross-domain maps. Localization, retention, convergence, and PA43 remain open.
- `foundations/endpoint-link-and-localization-boundary.md`—Gauge-Covariant Endpoint Closure and the Localization Boundary. Hypothesized Wilson-link extension / Derived conditional endpoint closure, frozen-link, source-action, stationary spatial-flux, and inter-vertex transport responses / Derived minimal-sector localization no-go—September 2026. Derives the endpoint covariance and localization tests used by the particle campaign and records the one-point PA42 qualification boundary.
- `foundations/point-core-flux-sector.md`—Quantized Point-Core Flux and the Persistent-Defect Boundary. Derived conditional exterior support / Derived current-action completion no-go / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Derives the point-flux coefficient and support inequality, then tracks the smooth-core, confinement, carrier, and fluctuation branches.
- `foundations/nonabelian-magnetic-core-boundary.md`—Non-Abelian Magnetic Core and the Confined-Defect Boundary. Hypothesized auxiliary completion / Derived conditional smooth-core and confinement boundaries / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Tests the adjoint $SU(2)_Q$ lift, smooth BPS core, condensate confinement, pair-collapse boundary, and one-point PA42 result.
- `foundations/core-trapped-charge-support.md`—Core-Trapped Noether Charge and the Finite-Composite Boundary. Hypothesized auxiliary carrier / Derived conditional thin-tube support boundary / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Derives the neutral-carrier number, retention condition, $A_C/L$ support term, and reduced stable separation. The selected field fails localization and retention, and no D/H background passes Q2.
- `foundations/particle-stationary-action-closure.md`—Particle-Sector Action and Fixed-Charge Variational Closure. Hypothesized source-free temporal completion / Derived gauge, Gauss, stationary, variational, and fluctuation-qualification boundaries / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Supplies the fixed-charge action, strict-shell $C_4$ quotient, PA42 Hessian, and PA43 mixed pencil. The global phase mode remains grid-scale; domain/resolution convergence and PA43 remain open.
- `foundations/matter-completion-boundary.md`—Matter Completion Boundary: Nine Conditions from Coherence to a Particle Calculation. Derived conditional boundary / Hypothesized physical realization / Tested reduced receipts, one-point precision-qualified background, and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Connects the exterior, interface, transport, power, reservoir, stress, gravity, particle-map, and spectrum conditions while retaining the localization, convergence, and dynamical boundaries.
...
- `foundations/proton-coherence-budget.md`—Proton Coherence Budget and Planck-to-Proton Scale Circuit. Mapped proton coordinate / Derived conditional arithmetic and current identities / Hypothesized physical mechanisms / Tested one-point precision-qualified background and nonnegative $C_4$ finite-grid PA42 Hessian—September 2026. Separates the independent-step lifetime arithmetic from the two-rail current mechanism, then follows the endpoint, point-core, confinement, carrier, and fixed-charge particle branches. The global phase mode remains grid-scale, localization and convergence remain open, and no physical proton lifetime follows.
