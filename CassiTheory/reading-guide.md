...
- `turbulence/navier-stokes-replica-coherence.md`—Replica Coherence and Viscous Compensation in Navier–Stokes. Derived exact replica, covariance, coherence-share and conditional continuation identities / Open all-data compensation bound—September 2026. Two independent stochastic Cauchy replicas recover enstrophy through overlap and covariance through disagreement. The covariance source is twice viscous palinstrophy and its Duhamel law retains subsequent directional deformation. Global coherence obeys a replicator-diffusion equation; volume preservation supplies a sharp full-rank lower bound and compensated enstrophy envelope. Rank-deficient collapse controls prevent a deformation-independent extension. Periodic shear realizes the zero-determinant boundary and decaying ABC flow activates the full-rank term. Forty source-bound symbolic and exact-control checks pass; the uniform initial-$H^3$-controlled compensation bound remains open.
