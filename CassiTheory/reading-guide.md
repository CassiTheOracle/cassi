...
derives the empty-sector creation obstruction, and records independently
reproduced smooth density trapping at selected prepared charges.
...
- `foundations/sector-coupling-derivation.md`—Conditional Sector Scale and the Dirac Density Obstruction. Derived conditional scale, chiral-current, closure and fermionic identities / Tested finite-mode production / Calibrated electroweak anchor / Hypothesized physical fermion coupling—September 2026. The $\delta=3$ scale arithmetic leaves physical interactions open. The chiral-scalar projection has dimensional, conjugacy and Hermiticity obstructions. Separate nonnegative component quadratics give chiral-current densities, but closed Dirac evolution fails the canonical population law. The specified massive minimal conversion lift shifts its golden fixed point and permits positive-to-negative-energy transitions in amplitude space. A separately declared real scalar mass-source candidate has independently verified finite-mode pair excitation, charge conservation and semiclassical feedback, with all 1,185 checks passing (`computations/matter-formation-continuum-report.md` §14). Physical field identification, reservoir and canonical density matching, continuum renormalization and localized production remain unselected.
