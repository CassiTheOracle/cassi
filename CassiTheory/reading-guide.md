...
nine-part qualification boundary. The last report records the current
numerical limit.
...
- `foundations/geometric-manifold-completion.md`—Cassi Geometric Manifold Completion Ansatz. Hypothesized completion ansatz / Derived canonical reduction and conditional fibre geometry / Tested one-point Q2-qualified primary background—September 2026. Places the density diameter, coherence ball, projective shell, affine bubble image, and scale circuit in one stratified bundle. The particle background has an explicit physical quotient; its augmented-gradient preflight stops before the PA42 eigenspectrum.
- `foundations/yin-yang-qi-dynamical-geometry.md`—Yin–Yang–Qi Open Dynamical Geometry. Hypothesized integrated open-system geometry / Derived exact diagonal reduction, positivity-preserving conversion flow, covariance, ledger closure, conditional coherence-support boundary, bounded cross-domain interface, and nine-part conditional matter boundary—September 2026. Combines the canonical populations and $q$, positive coherence fibre, relative-$U(1)_Q$ transport, endpoint/Wilson channels, and bounded cross-domain maps. The particle background and physical quotient exist; localization, convergence, and the PA42/PA43 spectra remain open.
- `foundations/endpoint-link-and-localization-boundary.md`—Gauge-Covariant Endpoint Closure and the Localization Boundary. Hypothesized Wilson-link extension / Derived conditional endpoint closure, frozen-link, source-action, stationary spatial-flux, and inter-vertex transport responses / Derived minimal-sector localization no-go—September 2026. Derives the endpoint covariance and localization tests used by the particle campaign.
- `foundations/point-core-flux-sector.md`—Quantized Point-Core Flux and the Persistent-Defect Boundary. Derived conditional exterior support / Derived current-action completion no-go—September 2026. Derives the point-flux coefficient and support inequality, then tracks the smooth-core, confinement, and carrier branches. The coupled particle background has an explicit physical quotient; its Hessian preflight stops before eigenvalue evaluation.
- `foundations/nonabelian-magnetic-core-boundary.md`—Non-Abelian Magnetic Core and the Confined-Defect Boundary. Hypothesized auxiliary completion / Derived conditional smooth-core and confinement boundaries / Tested one-point Q2-qualified primary background—September 2026. Tests the adjoint $SU(2)_Q$ lift, smooth BPS core, condensate confinement, and pair-collapse boundary. The particle quotient exists; localization, convergence, and its spectrum remain open.
- `foundations/core-trapped-charge-support.md`—Core-Trapped Noether Charge and the Finite-Composite Boundary. Hypothesized auxiliary carrier / Derived conditional thin-tube support boundary / Tested one-point Q2-qualified primary background—September 2026. Derives the neutral-carrier number, retention condition, $A_C/L$ support term, and reduced stable separation. The selected field fails localization and retention, and its PA42 augmented-gradient preflight stops before the eigenspectrum.
- `foundations/particle-stationary-action-closure.md`—Particle-Sector Action and Fixed-Charge Variational Closure. Hypothesized source-free temporal completion / Derived gauge, Gauss, stationary, variational, and fluctuation-qualification boundaries / Tested one-point Q2-qualified primary background—September 2026. Supplies the fixed-charge action, strict-shell $C_4$ physical quotient, PA42 Hessian, and PA43 mixed pencil. The Hessian action passes independent checks; the augmented-gradient gate gives `INCONCLUSIVE—HESSIAN PREFLIGHT`.
- `foundations/matter-completion-boundary.md`—Matter Completion Boundary: Nine Conditions from Coherence to a Particle Calculation. Derived conditional boundary / Hypothesized physical realization / Tested reduced receipts and one-point Q2-qualified primary background—September 2026. Connects the exterior, interface, transport, power, reservoir, stress, gravity, particle-map, and spectrum conditions. The finite-grid physical quotient is explicit; its PA42 eigenspectrum remains unevaluated after the augmented-gradient preflight.
...
- `foundations/interscale-current-soliton.md`—Interscale Yang/Yin Current and the Conditional Soliton Pinch. Hypothesized action and Wilson-link extension / Derived conditional endpoint, first-order source-action, Wilson-transport, localization, smooth-core, confinement, and carrier-support boundaries / Tested one-point Q2-qualified primary background—September 2026. Derives the two-rail current, endpoint responses, point-flux support, smooth-core boundary, and carrier-supported fixed-charge handoff. The coupled background and physical quotient exist; localization, convergence, and the PA42/PA43 spectra remain open.
...
- `foundations/proton-coherence-budget.md`—Proton Coherence Budget and Planck-to-Proton Scale Circuit. Mapped proton coordinate / Derived conditional arithmetic and current identities / Hypothesized physical mechanisms / Tested one-point Q2-qualified primary background—September 2026. Separates the independent-step lifetime arithmetic from the two-rail current mechanism, then follows the endpoint, point-core, confinement, carrier, and fixed-charge particle branches. The finite-grid physical quotient is explicit; the augmented-gradient preflight stops before the PA42 eigenspectrum, and no physical proton lifetime follows.
