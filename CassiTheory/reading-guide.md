...
- `foundations/loop-to-bubble-projection-theorem.md`—Loop-to-Bubble Projection Theorem: Shared-Support Counterflow, Coherence, and Scale Separation. Derived conditional projection and population spectrum; Derived regulated pure-gauge comparisons; Hypothesized microscopic physical identification—September 2026. The four carrier populations project to the canonical PDE under common gate and transport assumptions, and their coherence fills the affine bubble volume. The internal generator supplies a relaxation-rate gap. The separate pure-$SU(2)$ comparison gives an electric threshold, a Wilson-energy obstruction to projector-only closure, a volume-uniform strong-bare-coupling gap by Yarotsky's theorem, and an exact finite-depth gauge-invariant vacuum dressing with a bounded local quadratic remainder. Carrier identification, weak-bare-coupling uniform control and four-dimensional continuum construction remain open.
...
Conditional turbulence spectra, exact Navier–Stokes transfer identities, geometric regularity questions, and a bounded Cassi fluid-feasibility study.
