...
- `foundations/interscale-current-soliton.md`—Interscale Yang/Yin Current and the Conditional Soliton Pinch. Hypothesized action / Derived conditional algebra—August 2026. Introduces a complex doublet on a separately normalized continuous scale coordinate, derives exact species and total continuity plus co-flow/counterflow identities, and identifies a conditional mixed-curvature force channel. The positive action does not relax the Yang/Yin ratio or guarantee a soliton; finite radius, topology change, compact flux, local scale embedding, mass scaling, and particle identification require additional inputs.
