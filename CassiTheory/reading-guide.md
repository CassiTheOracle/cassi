...
- `foundations/loop-to-bubble-projection-theorem.md`—Loop-to-Bubble Projection Theorem: Shared-Support Counterflow, Coherence, and Scale Separation. Derived conditional projection and population spectrum; Derived regulated pure-gauge identities and conditional block theorem; Hypothesized microscopic physical identification—September 2026. The four carrier populations project to the canonical PDE, and their coherence fills the affine bubble volume. The separate pure-$SU(2)$ comparison gives an electric threshold, a Wilson-energy obstruction to projector-only closure, a strong-bare-coupling uniform gap, an exact finite-depth vacuum dressing and an exact finite-regulator vacuum-measure gap identity. A conditional full-holonomy theorem isolates sufficient fibre-rate, tensorization and cover estimates. Fixed controls exclude the equal-weight one-plaquette exact vacuum, conditional gaps alone as a uniform argument and static pure marginalization as an exact quantum reduction. Carrier identification, interacting-vacuum weak-coupling estimates and the four-dimensional continuum construction remain open.
...
- `turbulence/compressible-radiative-plasma-closure.md`—Compressible Radiative Plasma and Stellar-Light Closure. Derived conditional / Tested reference controls—September 2026. Closes mass, momentum and total energy with pressure work and shocks; evolves finite species and level populations for line and continuum transfer; accounts for contraction, accretion, nuclear power and neutrino loss; and preserves crossing beams with discrete ordinates. Its source-snapshotted schedule passes 70 of 70 checks. Physical Cassi material identification, evaluated data qualification and a production CassiCosmos solver remain open.
