...
- `turbulence/navier-stokes-strain-departure.md`—Strain Departure and Critical Spectral Concentration. Derived conditional estimates / Open data-controlled critical work—September 2026. Couples energy and enstrophy to sharpen the departure-or-breakdown deadline and quantify necessary excess dose; 71 checks. Bounds critical remainder and complete nonlinear transfer using spectral spread, derives its exact dynamics and exhibits periodic broadening from a single frequency radius. A positive-moment scalar construction defeats closure from the listed budgets; 134 separate checks. The forced extension supplies exact source budgets, a conditional critical forcing estimate and the compactness boundary for vanishing-source magnification; 215 checks in both the frozen preregistered run and its separate post-run qualification. Dynamical control of the sufficient spectral condition, arbitrary-data regularity and unforced blow-up remain open in this analysis.
- `turbulence/cassi-fluid-feasibility.md`—Cassi Fluid Mechanics: Conservative Reduction and Native-Force Boundary. Derived conditional conservative reduction and native-force obstruction / Tested solver controls / Open physical-fluid completion—September 2026. Derives first-order pressure, counterflow and quantum momentum flux with a supplied mass; gives scalar nonnegativity and relative entropy under stated assumptions. The actual solver passes 246 checks across 28 trajectories, including ordinary-fluid correspondence controls and the predicted periodic self-acceleration. Physical replacement promotion is **REJECT**; concentration arrest is **NOT_RUN**.
