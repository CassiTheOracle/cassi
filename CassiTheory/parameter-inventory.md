...
| Matter-formation qualification witnesses | compact radial, relative-orientation and soft-adjoint qualification outputs | compact shifted-angle primary 34 checks and verifier 121; full variation $59/59$ exact identities and $8/8$ predicates | **Tested conditional comparison outputs.** They qualify the stated finite-domain and soft-domain calculations; they do not select physical normalization, production, metastability or particle identity and are not §7 parameters (`computations/matter-formation-continuum-report.md` §§18.6, 19.6, 20.6) |
...
**Row count: 44.** A row here records the quantity's epistemic status. Each
