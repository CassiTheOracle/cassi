...
| $g,a,x$ in the pure-gauge comparison | supplied bare $SU(2)$ coupling, lattice spacing and electric-expansion parameter | $g,a>0$, $x=2/g^4$; $\Delta_E=3g^2/(2a)$ on the specified girth-four graph | **External target-theory inputs / Derived regulated spectrum**, `foundations/loop-to-bubble-projection-theorem.md` §§9.4–9.16. Numerical couplings and representation cutoffs are fixed controls. No Cassi parameter, fitted value, physical mass prediction or change to the §7 count is introduced |
