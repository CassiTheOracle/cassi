...
| $\mu_{a,L},\lambda_{\mathrm{gi}},\lambda_{\mathrm{loc}},A_{\mathrm{AT}},\rho,C_B$ in the pure-gauge comparison | exact finite-vacuum measure, gauge-invariant and conditional Poincaré rates, tensorization constant, cover multiplicity and boundary density-ratio oscillation | $\Delta_{\mathrm{phys}}=(g^2/2a)\lambda_{\mathrm{gi}}$ and $\lambda_{\mathrm{gi}}\ge\lambda_{\mathrm{loc}}/(A_{\mathrm{AT}}\rho)$ under the hypotheses of (YM29)–(YM31) | **Derived regulated identity / Derived conditional sufficient theorem**, `foundations/loop-to-bubble-projection-theorem.md` §§9.13–9.14. These target-theory mathematical quantities introduce no fitted Cassi parameter. Their cutoff- and volume-uniform weak-coupling bounds remain open, and they do not change the §7 parameter count |
