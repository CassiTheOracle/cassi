...
- `predictions/falsifiable-predictions.md`—prediction catalog: 51 numbered predictions grouped by experiment (FCC-ee, CMB-S4, LSST…), each with a `**Source:**` block. Cited elsewhere by number / `§`.
