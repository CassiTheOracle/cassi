...
- `predictions/falsifiable-predictions.md`—prediction catalog: 52 numbered predictions grouped by experiment (FCC-ee, CMB-S4, LSST…), each with a `**Source:**` block. Cited elsewhere by number / `§`.
...
| `predictions/falsifiable-predictions.md` | 52-prediction catalog |
