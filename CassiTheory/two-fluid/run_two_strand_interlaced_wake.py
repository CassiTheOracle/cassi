...
1391.96} collapses (NaN at t = 1.0 / 0.5 / 0.3): the mass-like flux
sharpens the eps-wall to grid scale, |grad eps|^2 grows without bound
(the (1-q) gate floor keeps the source alive), and W explodes to
1e8-1e11; below the bracket (g <= 38) the run survives t = 2 but
over-contracts the pair (d -> 3-4 cells) with growing focusing.  The
wake family is closed as an E1 mechanism; g is NOT registered (T4/T5
failed).  The frozen-init anti-collapse audit (T2) does not bound the
