...
| Residual recovery Gramian | `runs/yang_mills_recovery_gramian/verification.json` — source-bound primary receipt, `PASS`, 58 checks | `verification-independent.json` — `PASS`, 30 checks, binding the protocol, both verifier sources and the primary receipt | Finite projection, Gaussian, quotient and score controls pass; this is a fixed-control result only, not a uniform exact-vacuum recovery floor or transported-score bound |
...
The residual-recovery pair is also source-bound: the primary receipt passes 58 checks and the independent reconstruction passes 30 checks while binding the frozen protocol, both verifier sources and the unchanged primary receipt. Its finite controls qualify the identities in (YM152)–(YM170); they do not instantiate the regulator-uniform recovery or score constants required by (YM160) and (YM170).
...
## 5. Source-bound reconciliation against UFA and YMRG

The residual-recovery Gramian is a separate source-bound finite control. The
live hashes currently recomputed for its protocol, independent verifier,
primary verifier and primary receipt are respectively
`a63fd71328f80d7f0d9ceccbad46009b7a3be65f511e750f952a69f4e71c4510`,
`bf8a8d99b8f899c4902c1a08b33ab38afa19c36f1d802672ee71b09d85447f20`,
`7057f5a82071d741dbf4bee76d4b61ff28ce55ae76c1fec6900f04ec0145bc42`
and
`2af20947db7832612069ac13c3ff53ce77fa4d21f7259f98ce5e28ad07638071`.
These equal the hashes declared by its independent receipt. The primary
receipt has 58 passing checks and the independent receipt has 30/30 passing
checks. This establishes the finite receipt binding and the declared
recovery identities; it does not establish a uniform recovery certificate.

| Source-bound finite evidence | Obligation content exercised | Boundary that remains |
|---|---|---|
| Residual recovery Gramian | YMRG1 and YMRG3–YMRG5 finite projection, quotient, Gaussian, score-separation and mutation controls | YMRG2's regulator- and scale-uniform recovery floor, exact-vacuum conditional rates, cover constants and transported score bound remain open; this receipt is separate from the Hamiltonian Feshbach blocks |
| Recovered larger-volume Hamiltonian | Finite gauge-invariant basis, spectator-channel recovery, plaquette support, Wilson bounds and Hamiltonian positivity on the declared $3\times2\times2$ graph | The four aggregate cutoff qualifications are `INCONCLUSIVE`; no boundary-fibre disintegration, coarse transfer, uniform discarded resolvent or continuum recovery follows |
| Fixed-graph interacting Feshbach and finite-volume bridge families | UFA47–UFA51 / UF-C finite shifted Schur inequalities on the declared graphs, cutoffs and couplings | No UFA61–UFA69 fibre construction, regulator-independent $\delta_{\mathrm{fib},*}$ or $W_*$, volume-uniform $\alpha,\delta_Q,\beta$, UF-D transport or UF-E continuum sequence is supplied |
| Local observable completeness and fixed-graph cutoff receipts | YM259–YM260 density criteria, finite Peter–Weyl cutoff removal and fixed-support local-density controls | Density does not construct the exact coarse map or the uniform lower form bound in YM262; boundary form compatibility and the continuum recovery direction remain conditional |
| Continuum-boundary audit | Hash-bound reconciliation of the retained finite receipts and the conditional thermodynamic, Euclidean, anisotropic, scaling and RG implication records | Its `UNRESOLVED_CONTINUUM_PROBLEM` / `NULL` result is the correct boundary: no four-dimensional continuum field, regulator-independent interacting gap or Clay proof is constructed |

No retained receipt instantiates the complete UFA61–UFA69 package: declared
boundary fibres, disintegration, $S$-metric, $P/Q$ form domains, fixed
$z$-domain, measurable covariant partial isometries and a
regulator-independent constant strategy. The next admissible work is therefore
the source-bound construction of that package and its uniform-bound strategy,
not another repeated-edge, exact-block or finite Feshbach run.
