...
print(f"    Convergent errors |φ - F_(k+1)/F_k| fall like φ^(-2k). Under any fixed")
print(f"    relative tolerance the admitted levels are cofinite, not finite: 27 of")
print(f"    30 levels (k ≥ 4) at 5%, 25 of 30 (k ≥ 6) at 1%. A tolerance therefore")
print(f"    fixes no count of distinct coherence scales; the countable content is")
print(f"    the growth comparison F_k vs k, filter (1) below.")
print()
...
print(f"    The gap g = 1-φ^{-5} is a conditional result of the")
print(f"    two-filter construction in `foundations/wu-xing-derivation.md`:")
...
print(f"    Under these filters, the intersection selects w = 5 and")
print(f"    g = 1-φ^{-5}.")
print()
...
print(f"    provides the lower bound. Their combination is conditional on")
print(f"    the coherence and geometry assumptions.")
print()
print(f"    Status: Hypothesized conditional construction. The coherence")
print(f"    criterion is a physical bridging postulate (error ≤ signal for")
print(f"    cycle closure), PDE-testable.")
print(f"    The other steps are mathematical identities or PDE-derived formulas.")
print(f"    ")
