#!/usr/bin/env python3
"""Audit the collective plaquette Feshbach receipt without assembling matrices."""
...
PRIMARY_SOURCE = ROOT / "computations/verify_yang_mills_volume_collective_feshbach.py"
...
PRIMARY = ROOT / "runs/yang_mills_volume_collective_feshbach/verification.json"
DEFAULT_OUTPUT = ROOT / "runs/yang_mills_volume_collective_feshbach/verification-independent.json"
...
def audit() -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        "schema": "cassi.yang-mills.volume-collective-feshbach.independent.v1",
    ...
    record_check(result, "primary status and complete checks",
                 ...
                 and primary.get("classification") == "SUPPORTS_FINITE_VOLUME_COLLECTIVE_PLAQUETTE_FAMILY"
    ...
    record_check(result, "fixed collective schedule",
    ...
    for graph in EXPECTED_DIMENSIONS:
        ...
        record_check(result, f"{graph} collective source rank and singular values",
    ...
    record_check(result, "scientific classification arithmetic",
                 primary.get("classification") == "SUPPORTS_FINITE_VOLUME_COLLECTIVE_PLAQUETTE_FAMILY"
