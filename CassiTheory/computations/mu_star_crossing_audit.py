...
print("    [measured Z-pole couplings] + [SM β-functions] + [asserted φ⁻³]:")
print("    no free parameter. It is NOT independently selected by a Cassi")
print("    dynamics: the trajectory is anchored to measurement, φ⁻³ is")
print("    asserted (blocking step documented), and the rung-80 coincidence")
print("    (n(μ*) = 80.0–80.1) sits inside the same 5%-residual class as the")
print("    calibrated VEV anchor. Tier: Calibrated (consistent with")
print("    foundations/cassi-theory-reference.md — realized at μ* = 233 GeV,")
print("    ledger row 490).")
print()
