"""Run the preregistered outgoing CP-odd reservoir formation calculation.

Run from the CassiTheory root:
    python computations/matter_formation_closed_cp_reservoir_v5.py \
        --output-dir runs/20260912_matter_formation_closed_cp_reservoir_v5
"""
...
DEFAULT_OUTPUT = ROOT / "runs/20260912_matter_formation_closed_cp_reservoir_v5"
SCHEMA = "cassi.matter-formation.closed-cp-reservoir.v5"
...
def initial_state(
    ...
    pv = -sign * reservoir_amplitude * np.exp(-0.5 * (r / RESERVOIR_WIDTH) ** 2) * (
