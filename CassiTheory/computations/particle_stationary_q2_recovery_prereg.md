# Particle Stationary Q2 Recovery Campaign
...
9. every reconstructed objective term and diagnostic is finite;
10. reconstructed objective components and diagnostics agree with the source
    receipt under (QR10);
11. for each field $f\in\{\psi_R,\psi_I,h,a,c\}$,
...
- `computations/particle_stationary_q2_recovery.py`

Independent verifier:

- `computations/verify_particle_stationary_q2_recovery.py`

Frozen run directory:

- `runs/20260902_particle_stationary_q2_recovery/`
...
```text
python computations/verify_particle_stationary_q2_recovery.py --preflight
python computations/particle_stationary_q2_recovery.py
python computations/verify_particle_stationary_q2_recovery.py
```
