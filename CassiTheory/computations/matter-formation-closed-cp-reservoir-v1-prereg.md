# Closed CP-Odd Reservoir Formation of a Non-Topological Carrier
...
`computations/matter_formation_closed_cp_reservoir_v1.py` and
`computations/verify_matter_formation_closed_cp_reservoir_v1.py`. The verifier
