#!/usr/bin/env python3
"""Run the preregistered fixed-charge packet charge-partition basin probe."""
...
def run_campaign(output: Path) -> dict[str, Any]:
    ...
    if not comparison_pass or not rule_control["pass"]:
        ...
        verdict = "EMERGES—conditional bound remnant in the declared charge-partition basin"
    else:
        verdict = "DOES NOT EMERGE in the specified charge-partition calculation"
    receipt = {
        "schema": SCHEMA,
