...
Run from the CassiTheory root:
    python computations/matter_formation_closed_cp_reservoir_v4.py \
        --output-dir runs/20260912_matter_formation_closed_cp_reservoir_v4
"""
...
DEFAULT_OUTPUT = ROOT / "runs/20260912_matter_formation_closed_cp_reservoir_v4"
SCHEMA = "cassi.matter-formation.closed-cp-reservoir.v4"
