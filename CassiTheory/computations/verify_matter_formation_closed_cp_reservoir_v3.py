...
PRIMARY = ROOT / "computations/matter_formation_closed_cp_reservoir_v3.py"
PROTOCOL = ROOT / "computations/matter-formation-closed-cp-reservoir-v3-prereg.md"
SCHEMA = "cassi.matter-formation.closed-cp-reservoir.v3.verification"
RADIUS = 48.0
N_PRIMARY = 384
N_FINE = 768
DT_PRIMARY = 0.003
...
def main() -> int:
    ...
    if primary.get("schema") != "cassi.matter-formation.closed-cp-reservoir.v3":
