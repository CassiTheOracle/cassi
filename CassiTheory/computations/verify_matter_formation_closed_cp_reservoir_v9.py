#!/usr/bin/env python3
"""Independently reconstruct the carrier-frequency-resonant autonomous receipt."""
...
PRIMARY = ROOT / "computations/matter_formation_closed_cp_reservoir_v9.py"
PROTOCOL = ROOT / "computations/matter-formation-closed-cp-reservoir-v9-prereg.md"
SCHEMA = "cassi.matter-formation.closed-cp-reservoir.v9.verification"
RADIUS = 48.0
N_PRIMARY = 384
N_FINE = 768
DT_PRIMARY = 0.003
...
G = 1.25
M_A = 0.5
RESERVOIR_WAVENUMBER = math.sqrt(3.0) / 2.0
...
def main() -> int:
    ...
    if primary.get("schema") != "cassi.matter-formation.closed-cp-reservoir.v9":
