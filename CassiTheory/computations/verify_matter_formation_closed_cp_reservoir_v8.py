#!/usr/bin/env python3
"""Independently reconstruct the resonantly matched autonomous reservoir receipt."""
...
PRIMARY = ROOT / "computations/matter_formation_closed_cp_reservoir_v8.py"
PROTOCOL = ROOT / "computations/matter-formation-closed-cp-reservoir-v8-prereg.md"
SCHEMA = "cassi.matter-formation.closed-cp-reservoir.v8.verification"
RADIUS = 48.0
N_PRIMARY = 384
N_FINE = 768
DT_PRIMARY = 0.003
...
G = 1.25
M_A = 1.0
RESERVOIR_WAVENUMBER = math.sqrt(3.0)
...
def main() -> int:
    ...
    if primary.get("schema") != "cassi.matter-formation.closed-cp-reservoir.v8":
