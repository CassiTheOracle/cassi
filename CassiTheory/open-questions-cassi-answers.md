...
source-and-sink patterns have an inverse-Laplacian phase reconstruction and a
strictly positive endpoint gradient cost; a uniform nonzero circuit source
requires boundary flux or additional endpoint transport.
