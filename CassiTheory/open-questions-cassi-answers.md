...
|| **Hypothesized** (mechanism, needs computation) | 18 | Hubble tension (C3), inflation $n_s$ (C4), horizon (C6), cosmic web (C9), neutrino spacings (Q3), 3+1 dimensions (G5), unification (F3), TOE (F4), dimensionful constants (F5), JWST galaxies (T2), $\sigma_8$ (T3), $H_0$ tension (T4), consciousness (all M1–M5), **BH information (G2)**, **$P_\parallel(n)$ (F6)** |
