...
| `turbulence/navier-stokes-strain-departure.md` | Derived conditional estimates / Open data-controlled critical work—September 2026 | Energy-coupled departure-or-breakdown deadline and necessary cumulative defect; 71 checks. Centered critical remainder and full-transfer bounds, exact spectral-spread dynamics, periodic loss of zero spread and a positive-moment scalar obstruction; 134 separate checks. Forced source budgets, conditional source absorption, vanishing rescaled force and a kinematic concentration control; 215 checks in both the frozen preregistered run and the separate post-run qualification. No trajectory, data-controlled recurrence estimate, unforced blow-up construction or audit of the announced forced proof |
| `turbulence/cassi-fluid-feasibility.md` | Derived conditional conservative reduction and native-force obstruction / Tested solver controls / Open physical-fluid completion—September 2026 | First-order pressure, quantum and counterflow momentum flux with supplied mass; scalar nonnegativity and relative entropy under stated assumptions; 246 checks including 28 native trajectories. The self-sourced force accelerates the periodic mean and fails a closed-fluid stress interpretation. Conditional Navier–Stokes controls pass; physical replacement promotion is **REJECT**, concentration arrest **NOT_RUN** |
