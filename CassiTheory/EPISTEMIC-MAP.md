...
| `turbulence/compressible-radiative-plasma-closure.md` | Derived conditional / Tested reference controls and integrity qualification—September 2026 | Conservative compressible mass, momentum and material-energy equations supply pressure work and Rankine–Hugoniot shocks; finite population generators connect versioned atomic data to line and continuum transfer; contraction, accretion and nuclear mass defect enter a complete stellar energy ledger; discrete ordinates preserve crossing beams. The source-snapshotted schedule passes 70 of 70 checks, and a separate 25-check integrity qualification covers state recovery, thermodynamic identities, rejection boundaries, exchange cancellation, complete stellar and nuclear ledgers, and missing-prerequisite classification. Cassi material identification, evaluated-data qualification, production finite-volume convergence and live CassiCosmos integration remain open. |
