...
| `turbulence/navier-stokes-depletion-dynamics.md` | Derived filtered identities and instantaneous obstructions / Conditional continuation estimate—September 2026 | Exact coarse/fine strain split, two-sided instantaneous response and a viscous-only absorption counterexample; 1,012 checks pass. The matter comparison distinguishes coercive binding and controlled linear exterior response. Data-controlled cumulative depletion and arbitrary-data regularity remain open |
