...
| `turbulence/navier-stokes-helical-dynamic-depletion.md` | Tested finite helical families / Universal sign depletion contradicted / Open scale-uniform direction-strain estimate—September 2026 | Eight pre-registered Fourier–Galerkin families measure the signed stretching production at every accepted state. The exact Beltrami control preserves $P$ at roundoff; the wide, narrow, tight-pitch, two-scale and opposite-handed tube families develop positive production by $t=1/8$, the opposite-handed pair with normalized helicity near $10^{-18}$, while the two mode families stay nonpositive. The 24-run matrix passes all integrity and refinement checks and classifies the universal sign statement `CONTRADICTS` for the declared families; the scale-uniform direction-strain estimate and global regularity remain open. |
