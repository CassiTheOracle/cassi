...
| `turbulence/navier-stokes-strain-departure.md` | Derived conditional estimates / Open data-controlled critical work—September 2026 | Earlier energy-coupled departure-or-breakdown deadline and necessary cumulative defect; 71 checks. Centered critical remainder and full-transfer bounds, exact spectral-spread dynamics, periodic loss of zero spread and a positive-moment scalar obstruction; 134 separate checks. No trajectory, data-controlled recurrence estimate or arbitrary-data regularity proof |
