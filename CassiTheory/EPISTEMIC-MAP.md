...
| `foundations/loop-to-bubble-projection-theorem.md` | Derived conditional projection and population spectrum; Derived regulated pure-gauge identities, exact isolated-square radial Feshbach transfer and weak-coupling character-cutoff theorem, exact character-cutoff form theorem on every fixed finite graph, volume-uniform local character-cutoff density theorem and global-norm obstruction, conditional fixed-regulator thermodynamic ground-state subsequence, exact fixed-link three-sphere geometry, two-scale conditional-score recurrence, $H^{-1}$ transport-score margin transfer, residual-recovery Gramian and score-penalty separation, exact fixed-boundary gauge-fibre support, conditional full-holonomy block theorem, and exact bare-cylindrical refinement obstruction; INCONCLUSIVE finite bowtie fibre probe; Hypothesized microscopic physical identification—September 2026 | The shared-loop law projects to the canonical PDE and fills the affine bubble volume. The source-free $SU(2)$ comparison supplies exact finite-regulator identities and conditional recurrence targets. Normalized-Haar tree coordinates and positivity of the complete Wilson potential give form-core convergence, discarded-mass decay and a noncommuting Ritz-error bound on each fixed finite graph; 22/22 primary and 18/18 independent controls pass with a `NULL` Clay verdict. Periodic-cubic symmetry and a constant-state variational estimate give a fixed-support cutoff bound uniform in volume; 16/16 primary and 17/17 independent controls pass, while the product family excludes global norm control from energy density alone. Conditional on the finite-volume ground densities and this local bound, trace-norm compactness and a diagonal subsequence give a compatible, symmetry-invariant locally normal fixed-regulator ground state; 18/18 primary and 19/19 independent finite-identity controls pass while explicitly excluding executable construction of the interacting states and tail bound. The eight-link loop-carrying bowtie study shows finite boundary sensitivity in all twelve cutoff/coupling blocks, while all 108 retained-rate rows remain INCONCLUSIVE under the residual and nested-rank rules. Uniform interacting-vacuum recovery, transport, fibre and coarse-margin estimates, full-sequence convergence, phase uniqueness, clustering, weak-coupling and lattice-spacing continuum control, a regulator-independent mass gap and Cassi identification remain open |
