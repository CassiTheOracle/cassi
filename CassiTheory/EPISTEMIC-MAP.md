...
The fixed-signed-charge energy and its rank-one radial Hessian correction
are **Derived conditional** (§8.10). All 24 frozen embeddings have
independently verified positive finite-grid radial curvature. Nine of
twelve domain/resolution comparisons pass; the three population-16 domain
failures leave aggregate radial-domain qualification **INCONCLUSIVE**.
The population-256 subset meets its measured radial comparisons. Full
spatial and dynamical stability remain open.
...
| `foundations/matter-completion-boundary.md` | Derived conditional boundary and microscopic non-identifiability / Mapped carrier coupling and conditional baryon benchmark / Hypothesized physical realization / Tested reduced receipts, prepared binding, finite-grid spectra, parent correspondences and radial baryon relaxation—September 2026 | Nine conditional sectors connect the exterior to the fixed-charge fluctuation problem. The evidence distinguishes exact empty-sector preservation, a Cartesian ultraviolet obstruction, prepared scalar binding, homogeneous finite-mode fermion excitation, continuum and energetic restrictions, periodic carrier amplification, faster spatial mediator instability, prepared local charge separation and a many-to-one microscopic inverse. The added chiral action supplies a Mapped stationary degree-one baryon benchmark but begins in that topological sector and depends on added field/action/quantum rules. Section 14 also records a separate massive $O(4)$ bubble-lattice comparison: its pion-selected parameter and nucleon/Delta-mapped coefficients give a finite radial profile, while all six target-bearing out-of-fit diagnostics `CONTRADICT` inherited thresholds; its finite-site $(S^3)^{N_s}$ regulator is simply connected and leaves quantum state, renormalization and physical identity open. The deterministic six-requirement adjudication returns `FAIL`; complete physical matter formation remains Hypothesized/Open |
