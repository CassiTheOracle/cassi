...
| `foundations/qi-loop-mass-cascade.md` | Derived conditional supplied-ring algebra / Tested conditional branch / Hypothesized physical identification—August 2026 | A declared compact two-fluid phase-gradient ratio $\alpha=\varphi$ yields a Fibonacci near-closure branch, positive stationary ring, and supplied scale covariance; 1,163 stable primitive modes and coefficient sensitivity leave unique physical mass selection open |
