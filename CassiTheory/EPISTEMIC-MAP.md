...
| `turbulence/navier-stokes-replica-coherence.md` | Derived exact replica, covariance, coherence-share and conditional continuation identities / Open all-data compensation bound—September 2026 | Two independent stochastic Cauchy replicas recover enstrophy through overlap and centred covariance through disagreement. The covariance source is twice viscous palinstrophy, and its Duhamel representation retains every source time and subsequent directional deformation. Global coherence obeys a replicator-diffusion law. Volume preservation gives a sharp full-rank determinant lower bound and compensated enstrophy envelope; rank-one and rank-two collapse families prevent a deformation-independent extension. Periodic shear realizes the rank-deficient boundary and decaying ABC flow activates the full-rank term. Forty source-bound symbolic and exact-control checks pass; a uniform initial-$H^3$-controlled compensated-occupation bound and arbitrary-data regularity remain **UNRESOLVED**. |
