...
| `turbulence/navier-stokes-strain-departure.md` | Derived conditional estimates / Open data-controlled critical work—September 2026 | Earlier energy-coupled departure-or-breakdown deadline and necessary cumulative defect; 71 checks. Centered critical remainder and full-transfer bounds, exact spectral-spread dynamics, periodic loss of zero spread and a positive-moment scalar obstruction; 134 separate checks. Forced source budgets, conditional source absorption, vanishing rescaled force and a kinematic concentration control; 215 further checks. No trajectory, data-controlled recurrence estimate, unforced blow-up construction or audit of the announced forced proof |
