...
| `foundations/loop-to-bubble-projection-theorem.md` | Derived conditional projection and population spectrum; Derived regulated pure-gauge identities, exact fixed-boundary gauge-fibre support, conditional full-holonomy block theorem, and exact bare-cylindrical refinement obstruction; Hypothesized microscopic physical identification—September 2026 | The shared-loop law projects to the canonical PDE and fills the affine bubble volume. In the separate source-free $SU(2)$ comparison, exact finite regulated gaps are gauge-invariant Poincaré rates and a conditional full-holonomy theorem isolates sufficient local-rate, tensorization and cover estimates. A normalized-Haar path-holonomy pullback is an exact endpoint-gauge-covariant electric isometry, but four unresolved plaquette characters on the fixed $2\times2$ refinement give $\|Qh_fJ1\|_2=2x_f$ and exclude that bare map as a full-Hamiltonian intertwiner. With all eight outer links fundamental, the internal Gauss fibre has exactly 14 states once $j_{\max}\geq1$ and conditional electric spacing $2g^2/a$; plaquette multiplication exits the fixed boundary sector. Coupled boundary-sector recoupling and self-energy control, weak-bare-coupling uniformity, the continuum quantum field, its mass and Cassi microscopic identification remain unresolved. |
