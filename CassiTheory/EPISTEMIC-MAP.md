...
| `foundations/loop-to-bubble-projection-theorem.md` | Derived conditional projection and population spectrum; Derived regulated pure-gauge identities and conditional block theorem; Hypothesized microscopic physical identification—September 2026 | The shared-loop law projects to the canonical PDE and fills the affine bubble volume. The supplied pure-$SU(2)$ framework gives an electric threshold, a Wilson-energy closure obstruction, a strong-bare-coupling uniform gap and exact finite-depth dressing. The exact ground-state transform identifies every finite regulated gap with a gauge-invariant Poincaré rate; a conditional full-holonomy theorem isolates sufficient fibre-rate, tensorization and cover estimates. Fixed controls exclude an equal-weight one-plaquette exact vacuum, conditional gaps alone as a uniform argument and static pure marginalization as an exact quantum reduction. Weak-bare-coupling interacting-vacuum control, continuum existence and physical carrier identification remain open |
