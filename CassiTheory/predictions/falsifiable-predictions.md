...
| $\sigma_8$ | $0.811$ | **−20.5% vs ΛCDM (pipeline total)** — the truth campaign's measured total (2026-08-07, N = 32/64/128, linear-P(k) IC normalization; σ₈_ΛCDM 0.9917 vs σ₈_Cassi 0.7884 at a_f = 1.80; resolution-converged); the mechanism-attributable row **+29.7%** (G_eff = 1.297 — the doctrine r₀'s deep-Yin window q rises 0.30 → 0.41, growth enhancement; r₀-dependent: +29.4% at the derived r₀ = 0.0472, N=128; resolution-converged 0.1 pp, `cosmology/sigma8-computational-plan.md` §3.2); the settlement family: the stabilized closure's regime-integrated growth −16.6% (R = 0.834, P-A relative-μ, r₀ = 0.0472) and the band-state mean-field −15.2%; the pointwise-chord reading (the framework's pointwise-consistent form) at the closure freezes growth (−99.6% — contradicted by observation; the regime mismatch); the μ normalization remains Mapped | LSST discriminant — the computed values, not a target |
