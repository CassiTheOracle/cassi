...
| **MB-9** | Reduced stationary curvature and particle-spectrum boundary | The reduced carrier branch has one bounded positive-curvature separation and positive nonconstant line modes. The Cartesian localized field has six matched lowest constrained $C_4$ eigenpairs, a positive gap $0.01527618220595$ and a grid-scale phase direction. Its finest carrier norm is $99.98631608\%$ on one parity sublattice; the smooth-carrier interpretation is CONTRADICTS on the measured sequence. Separate continuum-consistent scalar binding at prepared $Q_C=16,256$ is reproduced independently; smooth $Q_C=16$ constrained spatial stability is INCONCLUSIVE | **Derived conditional reduced support / Tested algebraic receipts and finite-grid measurements / Mapped $h_C$ / Tested prepared smooth scalar binding.** The first-order carrier preserves empty-sector data. Production, full continuum and temporal stability, physical normalization and particle identity remain open | The reduced root or curvature fails its assumptions; independent reconstruction fails the stated measurements. Positive prepared binding and a finite-grid low-spectrum sign cannot establish creation or physical particle identity |
