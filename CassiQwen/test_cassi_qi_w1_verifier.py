...
_ARTIFACT = Path(__file__).with_name("_diag") / "cassi-qi-flow-w1-final" / "17b139068257ee2aa7be689f4e6ec2826229721c347c30ce2d0f26dbcb696b39"
...
class IndependentW1VerifierTests(unittest.TestCase):
    ...
    def test_sealed_w1_g1_artifact_passes_independently(self) -> None:
        ...
        self.assertEqual(result["receipt_count"], 10)
