"""Native-Qi loopback health, model-list, SSE, and receipt checks."""
...
def main() -> None:
    ...
    assert "chat.completion.chunk" in raw and "cassi.qi-native-displacement.v1" in raw and "data: [DONE]" in raw
    print("native-Qi OpenAI surface PASS")
