...
DEFAULT_BINARY = _CASSIQWEN_ROOT / "native/llama.cpp/b8/bin/Release/llama-server.exe"
DEFAULT_MODEL = _CASSIQWEN_ROOT / "Qwen3.8-27B-Q4_K_M.gguf"
DEFAULT_REF_RUN = _CASSIQWEN_ROOT / "_diag/workcases-b8-qifield-20260916"
RUNNER = str(_CASSIQWEN_ROOT / "benchmarks/run_cassi_field_qwen_workcases.py")
...
class Server:
    ...
    def __enter__(self) -> "Server":
        ...
        self.proc = subprocess.Popen([str(self.binary), *self.argv], cwd=str(self.binary.parent),
