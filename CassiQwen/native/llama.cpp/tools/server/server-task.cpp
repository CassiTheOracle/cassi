    ...
    const std::vector<metric_item> gauges = {
        {
            ...
            "cassi_modal_enabled",
            "Whether Cassi modal controls are enabled (configured state)",
            metrics.cassi_modal ? 1.0 : 0.0
        }, {
            "cassi_modal_retained_weight",
            "Configured Cassi modal retained weight",
            metrics.cassi_modal_retained_weight
        }, {
            "cassi_modal_phi",
            "Configured Cassi modal phi",
            metrics.cassi_modal_phi
        }, {
            "cassi_modal_dt",
            "Configured Cassi modal timestep",
            metrics.cassi_modal_dt
        }, {
            "cassi_modal_omega2",
            "Configured Cassi modal omega squared",
            metrics.cassi_modal_omega2
        }, {
            "cassi_modal_coupling",
            "Configured Cassi modal coupling",
            metrics.cassi_modal_coupling
        }, {
            "cassi_modal_steps_per_layer",
            "Configured Cassi modal integration steps per layer",
            (double) metrics.cassi_modal_steps_per_layer
        },
    };
