...
struct common_params {
    ...
    // Cassi modal controls (server-enabled by default; use --no-cassi-modal to opt out).
    bool  cassi_modal = true;
    float cassi_modal_retained_weight = 0.9f;
    float cassi_modal_phi = 1.61803398875f;
    float cassi_modal_dt = 0.005f;
    float cassi_modal_omega2 = 20.0f;
    float cassi_modal_coupling = 1.0f;
    int32_t cassi_modal_steps_per_layer = 4;
    bool cassi_field_step = false;
    int32_t cassi_field_layer = 32;
