...
private:
    ...
    void queue_cassi_field_state(const llm_graph_result * res, const llama_ubatch & ubatch);
    void complete_cassi_field_state();
    void queue_cassi_qi_field_state(const llm_graph_result * res, const llama_ubatch & ubatch);
    void complete_cassi_qi_field_state();
    ...
    llm_cassi_modal_config cassi_modal;
    std::vector<float> cassi_modal_state;

    llm_cassi_field_config cassi_field;
    std::vector<float> cassi_field_state;
    ...
    struct cassi_field_pending {
        bool valid = false;
        std::vector<llama_seq_id> seq_ids;
        std::vector<float> state;
    } cassi_field_pending;

    struct cassi_qi_pending {
        bool valid = false;
        std::vector<llama_seq_id> seq_ids;
        std::vector<float> state;
    } cassi_qi_pending;
