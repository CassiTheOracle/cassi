...
struct llama_cparams {
    ...
    bool     cassi_modal;
    float    cassi_modal_retained_weight;
    float    cassi_modal_phi;
    float    cassi_modal_dt;
    float    cassi_modal_omega2;
    float    cassi_modal_coupling;
    uint32_t cassi_modal_steps_per_layer;
