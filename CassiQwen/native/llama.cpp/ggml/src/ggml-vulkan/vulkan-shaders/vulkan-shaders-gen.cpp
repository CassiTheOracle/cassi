...
void process_shaders() {
    ...
    string_to_spv("cassi_modal_step_f32", "cassi_modal_step.comp", {});
    string_to_spv("cassi_field_step_f32", "cassi_field_step.comp", {});
    string_to_spv("cassi_qi_field_step_f32", "cassi_qi_field_step.comp", {});
    string_to_spv("cassi_field_resonance_f32", "cassi_field_resonance.comp", {});
