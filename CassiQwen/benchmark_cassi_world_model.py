...
def run(output_dir: Path, device_name: str | None = None) -> dict[str, Any]:
    ...
    payload = {
        ...
        "preregistration": str(Path(__file__).with_name("FULL-WORLD-MODEL-BENCHMARK-PREREG.md")),
        "preregistration_sha256": _sha256(Path(__file__).with_name("FULL-WORLD-MODEL-BENCHMARK-PREREG.md")),
