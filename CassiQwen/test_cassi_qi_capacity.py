...
from cassi_qi_scattering import QiInterval, QiPortDescriptor, QiScaleGeometryCandidate, QiTopologyCodebookEvidence
...
def _geometry() -> QiScaleGeometryCandidate:
    ...
    return QiScaleGeometryCandidate(
        ...
        periodic_fft_identity="fft-fixture",
        ...
        nullspace_bases=((1.0,),) * 3,
        retained_subspaces=((1.0,),) * 3,
...
def _profile(*, operators: dict[str, object] | None = None, layout: dict[str, object] | None = None, phases: object = (0.0, 3.141592653589793)):
    if operators is None:
        operators = {f"port-{scale}": {"reachability": ((1.0, 0.0), (0.0, 1.0)), "observability": ((1.0, 0.0), (0.0, 1.0))} for scale in range(4)}
