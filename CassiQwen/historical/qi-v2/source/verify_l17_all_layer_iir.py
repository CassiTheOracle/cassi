...
DEFAULT_CAPTURE = HERE / "all-layer-hidden-state-capture.json"
DEFAULT_SEED = HERE.parent / "CassiCosmos" / "_diag" / "cassi_qwen_all_layer_iir_seed.json"
DEFAULT_GPU = HERE.parent / "CassiCosmos" / "_diag" / "cassi_qwen_all_layer_iir_gpu.json"
DEFAULT_RECEIPT = HERE / "all-layer-iir-observatory.json"
...
def validate_reduced_receipt(
    ...
    expected_paths = {
        "capture": "CassiQwen/all-layer-hidden-state-capture.json",
