...
try:  # Direct ``python CassiQwen/...`` and package imports are both useful.
...
class RuntimeConfig:
    ...
    model_path: Path = field(default_factory=lambda: Path(__file__).resolve().parent / "Qwen3.8-27B-Q4_K_M.gguf")
    dll_dir: Path = field(default_factory=lambda: Path(__file__).resolve().parent)
