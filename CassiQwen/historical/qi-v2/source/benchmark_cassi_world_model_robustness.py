...
def run(output_dir: Path, device_name: str | None = None) -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        ...
        "preregistration": str(Path(__file__).with_name("FULL-WORLD-MODEL-ROBUSTNESS-PREREG.md")),
        "preregistration_sha256": _sha256(Path(__file__).with_name("FULL-WORLD-MODEL-ROBUSTNESS-PREREG.md")),
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("_diag/full-world-model-robustness"))
